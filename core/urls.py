...
urlpatterns = [
    ...
    path("integracoes/dji/docks/", dji_cloud_views.dji_docks, name="dji_docks"),
    path("integracoes/dji/missoes/", dji_cloud_views.dji_missoes, name="dji_missoes"),
    path("integracoes/dji/missoes/<int:pk>/enfileirar/", dji_cloud_views.dji_missao_enfileirar, name="dji_missao_enfileirar"),
    ...
    path("integracoes/dji/docks/missoes/<int:pk>/parametros/", dji_cloud_views.dji_dock_missao_parametros, name="dji_dock_missao_parametros"),
