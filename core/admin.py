...
from .models import DJIDock, DJIDockAcesso, DJIDockArquivo, DJIDockCanalVideo, DJIDockComando, DJIDockEvento, DJIDockMissao, DJIDRCComando, DJIDRCSessao, Piloto, Drone, Voo, Alocacao, Manutencao, TransmissaoAoVivo
...
admin.site.register(DJIDockAcesso)
admin.site.register(DJIDockCanalVideo)
